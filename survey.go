...
import (
	...
	"github.com/tsingson/survey/v2/core"
...
func defaultAskOptions() *AskOptions {
	return &AskOptions{
		...
		PromptConfig: PromptConfig{
			...
			Filter: func(filter, value string, index int) (include bool) {
...
type PromptConfig struct {
	...
	HelpInput        string
	SuggestInput     string
	Filter           func(filter, option string, index int) bool
	KeepFilter       bool
	ShowCursor       bool
...
func WithFilter(filter func(filter, value string, index int) (include bool)) AskOpt {
	return func(options *AskOptions) error {
